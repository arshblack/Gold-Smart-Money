---
permalink: /learn/tracks/read-structure/
title: "Read Structure"
content_id: RL-STR-INTRO
...
1. Mark swing highs and swing lows on any timeframe using a stated rule, so the same chart produces the same marks tomorrow.
2. Distinguish a break of structure from a change of character, and say out loud what each one does and does not confirm.
3. Run a top-down sequence — H1 context first, M15 second — and state a bias together with the specific price level that would invalidate it.
